...
# specs for one-to-many association (has_many & belongs_to)
...
These specs rely on a review_attributes method that returns example review attributes. 
Put this method in your spec/support/attributes.rb file.
